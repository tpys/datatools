...
class FaceDetector(object):
    ...
    def __init__(self,
        ...
        model_P = os.path.dirname(os.path.abspath(__file__)) + '/../model/det1.prototxt'
        weights_P = os.path.dirname(os.path.abspath(__file__)) + '/../model/det1.caffemodel'
        model_R = os.path.dirname(os.path.abspath(__file__)) + '/../model/det2.prototxt'
        weights_R = os.path.dirname(os.path.abspath(__file__)) + '/../model/det2.caffemodel'
        model_O = os.path.dirname(os.path.abspath(__file__)) + '/../model/det3.prototxt'
        weights_O = os.path.dirname(os.path.abspath(__file__)) + '/../model/det3.caffemodel'
